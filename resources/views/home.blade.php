...
<!-- Mirrored from templates.g5plus.net/homeid/home-08.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Mar 2022 06:31:53 GMT -->
...
<style>
    button.btn.dropdown-toggle.btn-lg.py-2.h-52.border-right.bg-white.bs-placeholder {
    DISPLAY: NONE;
}
...
.dropdown.bootstrap-select.form-control.shadow-none.form-control-lg.rounded-right-md-0.rounded-md-top-left-0.rounded-lg-top-left.flex-md-1.mt-3.mt-md-0 {
    display: none;
}

ul.navbar-nav.hover-menu.main-menu.px-0.mx-lg-n4 {
    display: none;
}

.d-none.d-lg-block {}

ul.navbar-nav.flex-row.justify-content-lg-end.d-flex.flex-wrap.text-body.py-2 {
    display: none !important;
}

.property-search-status-tab.d-flex.flex-row {
    display: none !important;
}

form.property-search.d-none.d-lg-block {
    padding: 16px 9px;
}

section.py-15.text-center.bg-cover {
...
#content > section.py-15.text-center.bg-cover > div > div:nth-child(2) {
    width: 50% !important;
    float: left;
}
</style>
...
<h3 class="d-none d-lg-inline-block">FYP</h3>
<h3 class="d-inline-block d-lg-none">FYP</h3>
</a>
...
<li id="navbar-item-pages" aria-haspopup="true" aria-expanded="false" class="nav-item dropdown py-2 py-lg-5 px-0 px-lg-4">
<a class="nav-link dropdown-toggle p-0" href="#" data-toggle="dropdown">
Pages
<span class="caret"></span>
</a>
...
<ul class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-lg-3" aria-labelledby="navbar-link-service">
<li class="dropdown-item">
...
<ul class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-lg-3" aria-labelledby="navbar-link-contact-us">
<li class="dropdown-item">
...
<ul class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-lg-3" aria-labelledby="navbar-link-agent">
<li class="dropdown-item">
...
<ul class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-lg-3" aria-labelledby="navbar-link-agency">
<li class="dropdown-item">
...
<input type="text" class="form-control form-control-lg border-0 shadow-none rounded-left-md-0 pr-8 bg-white placeholder-muted" id="key-word-1" name="key-word" placeholder="">
...
<div class="col-lg-2">
<a class="nav-link  px-2" data-toggle="modal" href="#login-register-modal">SIGN IN/ SIGNUP</a>
</div>
...
<select class="form-control border-0 shadow-none form-control-lg selectpicker bg-white" title="All status" data-style="btn-lg py-2 h-52 bg-white" name="type">
...
<p class="text-white letter-spacing-34 fs-15 text-uppercase lh-186 mb-0 pt-1">All Business Cards</p>

<span class="fs-md-52 font-weight-bold text-white pt-2 d-block"><img src="images/card.jpg"></span>
<span class="fs-md-52 font-weight-bold text-white pt-2 d-block"><img src="images/card.jpg"></span>

</div>

<div data-animate="fadeInDown">
<p class="text-white letter-spacing-34 fs-15 text-uppercase lh-186 mb-0 pt-1">Workpost</p>
...
<div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
    ...
    <input id="email" type="email" name="email" value="{{ old('email') }}" autocomplete="email" autofocus class="form-control border-0 shadow-none fs-13 @error('email') is-invalid @enderror" required placeholder="Your email">
        @error('email')
    ...
    <input id="password" type="password" name="password" required autocomplete="current-password" class="form-control border-0 shadow-none fs-13  @error('password') is-invalid @enderror" placeholder="Password">
        @error('password')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
    ...
    @if (Route::has('password.request'))
        <a class="d-inline-block ml-auto text-orange fs-15" href="{{ route('password.request') }}">
...
<input id="name" type="text" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus class="@error('name') is-invalid @enderror form-control border-0 shadow-none fs-13" placeholder="Your Name">
    @error('name')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
...
<input id="email" type="email" name="email" value="{{ old('email') }}" autocomplete="email" class="@error('email') is-invalid @enderror form-control border-0 shadow-none fs-13" placeholder="Your email">
    @error('email')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
...
<input id="password" type="password" name="password" required autocomplete="new-password" class="@error('password') is-invalid @enderror form-control border-0 shadow-none fs-13" placeholder="Password">
        @error('password')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
...
<input id="password-confirm" type="password" name="password_confirmation" required autocomplete="new-password" autocomplete="new-password" class="@error('password') is-invalid @enderror form-control border-0 shadow-none fs-13" placeholder="Confirm Password">
<div class="input-group-append">
<span class="input-group-text bg-gray-01 border-0 text-body fs-18">
<i class="far fa-eye-slash"></i>
</span>
...
<!-- Mirrored from templates.g5plus.net/homeid/home-08.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Mar 2022 06:32:01 GMT -->
</html>
