...
<!-- Mirrored from templates.g5plus.net/homeid/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Mar 2022 06:33:30 GMT -->
<!-- Added by HTTrack -->
                                        ...
                                        <div class="card-body px-6 pt-6 pb-5">
                                            <div class="row">
                                                <div class="col-sm-4 col-xl-12 col-xxl-7 mb-6">
                                                    ...
                                                    <p class="card-text">Under Development(FYP)</p>
                                                </div>
                                    ...
                                    <div class="card mb-6">
                                        <div class="card-body px-6 pt-6 pb-5">
                                            ...
                                            <div class="form-group">
                                                <label for="facebook" class="text-heading">User Name</label>
                                                <input type="url" class="form-control form-control-lg border-0"
                                                    id="facebook" name="facebook" value="{{auth()->user()->name}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="pinterest" class="text-heading">User Email</label>
                                                <input type="url" class="form-control form-control-lg border-0"
                                                    id="pinterest" name="pinterest" value="{{auth()->user()->email}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="instagram" class="text-heading">Address Line 1</label>
                                                <input type="url" class="form-control form-control-lg border-0"
                                                    id="instagram" name="instagram">
                                            </div>
                                            <div class="form-group">
                                                <label for="twitter" class="text-heading">Address Line 2</label>
                                                <input type="url" class="form-control form-control-lg border-0"
                                                    id="twitter" name="twitter">
                                            </div>
                                            <div class="form-group">
                                                <label for="linkedin" class="text-heading">Occupation</label>
                                                <input type="url" class="form-control form-control-lg border-0"
...
<!-- Mirrored from templates.g5plus.net/homeid/dashboard-my-profiles.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Mar 2022 06:33:35 GMT -->
